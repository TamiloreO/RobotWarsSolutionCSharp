...
namespace RobotWarsSolutionCSharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            valid = int.TryParse(Console.ReadLine(), out xMax);
            while (!valid) //Maximum x coordinate of rectangular ring
            {    
            ...
            valid = int.TryParse(Console.ReadLine(), out yMax);
            while(!valid) //Maximum y coordinate of rectangular ring
            {
            ...
            Console.WriteLine($"\nGreat, Here's the top view of your {xMax}" +
                $" by {yMax} arena in the form of coordinates(starting from 0)\n\n");
            ...
            valid = !(int.TryParse(Console.ReadLine(), out x) && x >= 0 && x <= xMax);
             while(valid)
            {
            ...
            valid = !int.TryParse(Console.ReadLine(), out y) || y < 0 || y > yMax;
            while (valid)
            {
            ...
            char cardinal;
            if (Char.TryParse(Console.ReadLine().ToUpper(), out cardinal) )
            {
                valid = cardinal != 'N' && cardinal != 'E' && cardinal != 'W' && cardinal != 'S';
                while (valid)
                {
                    Console.WriteLine($"\nInvalid cardinal {cardinal} letter detected");
                    Console.Write("Try again: ");
                    valid = Char.TryParse(Console.ReadLine().ToUpper(), out cardinal) && cardinal != 'N' && cardinal != 'E' && cardinal != 'W' && cardinal != 'S';
                }
            }  
